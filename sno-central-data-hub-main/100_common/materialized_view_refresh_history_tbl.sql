...
create transient table if not exists &{l_target_db}.&{l_target_schema}.materialized_view_refresh_history_stg
(
...
create table if not exists &{l_target_db}.&{l_target_schema}.materialized_view_refresh_history
(
