...
create transient table if not exists &{l_target_db}.&{l_target_schema}.serverless_task_history_stg
(
...
--
create table if not exists &{l_target_db}.&{l_target_schema}.serverless_task_history
(
