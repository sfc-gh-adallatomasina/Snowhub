...
--
create table if not exists &{l_target_db}.&{l_target_schema}.unmapped_resources
(
...
ALTER TABLE &{l_target_db}.&{l_target_schema}.unmapped_resources ALTER COLUMN RESOURCE_NAME DROP NOT NULL;