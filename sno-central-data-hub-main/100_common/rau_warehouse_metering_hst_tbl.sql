--  Purpose: create history table for reader account usage for warehouse metering
--
--  Revision History:
--  Date     Engineer      Description
--  -------- ------------- ----------------------------------
-- 15/03/23  sayali phadtare  history table will hold unique records based upon hash key
...
create table if not exists  &{l_target_db}.&{l_target_schema}.rau_warehouse_metering_history
(
...
ALTER TABLE &{l_target_db}.&{l_target_schema}.rau_warehouse_metering_history ALTER COLUMN WAREHOUSE_NAME DROP NOT NULL;