...
create transient table if not exists &{l_target_db}.&{l_target_schema}.QUERY_ACCELERATION_HISTORY_stg
(
...
--
create table if not exists &{l_target_db}.&{l_target_schema}.QUERY_ACCELERATION_HISTORY
(
