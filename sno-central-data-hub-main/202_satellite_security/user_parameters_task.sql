...
--  -------- ------------- ----------------------------------
-- 02/01/23	 Nareesh Komuravelly 	task to load data 
-----------------------------------------------------------------------------------------------------------   

CREATE OR REPLACE TASK &{l_target_db}.&{l_target_schema}.task_load_user_parameters
...
CALL &{l_target_db}.&{l_sec_schema}.sp_user_parameters_load();
END;
$$;
