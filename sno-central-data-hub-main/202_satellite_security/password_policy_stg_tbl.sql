--  Purpose: create stage table for password policy
--
--  Revision History:
--  Date     Engineer      Description
--  -------- ------------- ----------------------------------
-- 08/05/23  sayali phadtare  stage table for raw data collection from password policy in the account
...
CREATE TRANSIENT table IF NOT EXISTS &{l_target_db}.&{l_sec_schema}.PASSWORD_POLICY_STG (
